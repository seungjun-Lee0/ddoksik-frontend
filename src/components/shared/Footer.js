...
function Footer() {
  ...
  return (
    <footer class="app-footer">
		<nav class="menu-bar">
			<a href="/home" class="menu-bar-item menu-bar-item--active">
			...
			<a href="/home" class="menu-bar-item">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-data" viewBox="0 0 16 16">
        ...
        <path d="M10 7a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0zm-6 4a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0zm4-3a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1"/>
				...
				<span class="menu-bar-item-text">Plans</span>
			</a>
			<a href="/view-health-profile" class="menu-bar-item">
				<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
					<rect width="256" height="256" fill="none"></rect>
