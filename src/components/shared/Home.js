    ...
    return (
     ...
     <div class="search-menu">
      <div class="search-bar">
       ...
       <div class="search item">Breakfast
      ...
      <button class="search-button">Find My Diet</button>
     </div>
     <div class="main-container">
      ...
      <div class="searched-jobs">
       <div class="searched-bar">
        <div class="searched-show">Showing 46 Diets</div>
       ...
       <div class="job-cards">
        <div class="job-card">
         ...
         <div class="job-card-title">Diet Plans</div>
         <div class="job-card-subtitle">
            breakfast
         </div>
         <div class="job-detail-buttons">
          <button class="search-buttons detail-button">Apple</button>
          <button class="search-buttons detail-button">Brown Rice</button>
          <button class="search-buttons detail-button">Boiled Eggs</button>
         </div>
         <div class="job-card-buttons">
          <button class="search-buttons card-buttons">Add Foods</button>
          <button class="search-buttons card-buttons-msg">Undo</button>
         </div>
        </div>
        {/* <div class="job-card">
         <div class="job-card-header">
