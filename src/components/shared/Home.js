     ...
     <div className="main-container">
      ...
      <div className="searched-jobs">
       <div className="searched-bar">
        <div className="searched-show">Showing 46 Diets</div>
       ...
       <div className="job-cards">
        <div className="job-card">
         ...
         <div className="job-card-title">Diet Plans</div>
         <div className="job-card-subtitle">
            breakfast
         </div>
         <div className="job-detail-buttons">
          <button className="search-buttons detail-button">Apple</button>
          <button className="search-buttons detail-button">Brown Rice</button>
          <button className="search-buttons detail-button">Boiled Eggs</button>
         </div>
         <div className="job-card-buttons">
          <button className="search-buttons card-buttons">Add Foods</button>
          <button className="search-buttons card-buttons-msg">Undo</button>
         </div>
        </div>
        {/* <div className="job-card">
         <div className="job-card-header">
